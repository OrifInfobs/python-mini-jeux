"""
Display functions for the Sudoku grid in Game 5.
"""
...
def display_Grid(
    ...
    """
    Display the Sudoku grid with optional highlighting for hints, player moves,
    and a selected cell.

    Args:
        grid (list[list[int]]): The Sudoku grid.
        hint_positions (set[tuple[int, int]], optional): Positions of initial
            clues.
        player_moves (set[tuple[int, int]], optional): Positions filled by the
            player.
        selected_row (int, optional): Row index of the selected cell.
        selected_col (int, optional): Column index of the selected cell.
        marker (str, optional): Marker to use for selected/player cells.
    """
    ...
    for i, row in enumerate(grid):
        ...
        for j, num in enumerate(row):
            ...
            if (
                selected_row == i and selected_col == j and
